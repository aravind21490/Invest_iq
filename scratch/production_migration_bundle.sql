-- ==============================================================================
-- INVEST IQ PRODUCTION DATABASE MIGRATION BUNDLE (Phases 1-6)
-- Run this entire file in the Supabase SQL Editor of your production project.
-- Includes 0001_init, 0002_add_username_auth, 0003_agent_runs, 0004_portfolio_locks.
-- ==============================================================================


-- >>> START MIGRATION: 0001_init.sql <<<
-- ==============================================================================
...
-- >>> START MIGRATION: 0002_add_username_auth.sql <<<
-- ==============================================================================
...
-- >>> END MIGRATION: 0002_add_username_auth.sql <<<


-- >>> START MIGRATION: 0003_agent_runs.sql <<<
-- ==============================================================================
...
-- >>> END MIGRATION: 0003_agent_runs.sql <<<


-- >>> START MIGRATION: 0004_portfolio_locks.sql <<<
-- ==============================================================================
...
-- >>> END MIGRATION: 0004_portfolio_locks.sql <<<
